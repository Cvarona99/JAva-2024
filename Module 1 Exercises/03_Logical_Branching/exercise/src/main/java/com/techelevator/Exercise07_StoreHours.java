...
public class Exercise07_StoreHours {
    ...
    public boolean isStoreOpen(int currentHour, char currentDay) {
        if (currentHour >= 8 && currentHour <17 && currentDay == 'M')
        {
            return true;
        }
        else if (currentHour >= 8 && currentHour <17 && currentDay== 'W')
        {
            return true;
        }
        else
            return currentHour >= 8 && currentHour < 17 && currentDay == 'F';
    }
    ...
    public boolean isStoreOpen(int currentHour, char currentDay, boolean isSummer) {
        if (isSummer && currentDay == 'W' && currentHour >= 8 && currentHour <20)
        {
            return true;
        }
        ...
        boolean isOpen = (currentDay == 'M' || currentDay == 'W' || currentDay == 'F');
        return (currentHour >= 8 && currentHour < 17) && isOpen;
