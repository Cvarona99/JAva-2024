...
public class JdbcTransferDao implements TransferDao{
    ...
    public Transfer updateTransfer(Transfer transfer) {
        ...
        try {
            int rowsAffected = jdbcTemplate.update(sql, transfer.getTypeId(), transfer.getStatusId(), transfer.getAccountFromId(), transfer.getAccountToId(), transfer.getAmount(), transfer.getTransferId());
            if (rowsAffected == 0) {
